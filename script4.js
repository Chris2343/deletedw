...
(function(){
  ...
  theme.CartForm = (function() {
    ...
    CartForm.prototype = Object.assign({}, CartForm.prototype, {
      ...
      cartMarkup: function(text) {
        ...
        // Update subtotal
        this.subtotal.innerHTML = theme.Currency.formatMoney(subtotal, theme.settings.moneyFormat).replace('.00', '');;
      ...
      updateSubtotal: function(subtotal) {
        this.form.querySelector(selectors.subTotal).innerHTML = theme.Currency.formatMoney(subtotal, theme.settings.moneyFormat).replace('.00', '');
      },
      ...
      updateSavings: function(savings) {
        ...
        if (savings > 0) {
          var amount = theme.Currency.formatMoney(savings, theme.settings.moneyFormat).replace('.00', '');
  ...
  theme.buildProductGridItem = function(items, gridWidth, rowOf, imageSizes) {
    ...
    items.forEach(product => {
      ...
      if (theme.settings.predictiveSearchPrice) priceMarkup = `<div class="grid-product__price">${theme.strings.productFrom}${theme.Currency.formatMoney(product.price_min, theme.moneyFormat).replace('.00', '')}</div>`;
  ...
  theme.Product = (function() {
    ...
    Product.prototype = Object.assign({}, Product.prototype, {
      ...
      updatePrice: function(evt) {
        ...
        if (variant) {
          // Regular price
          this.cache.price.innerHTML = theme.Currency.formatMoney(variant.price, theme.settings.moneyFormat).replace('.00', '');
  
          // Sale price, if necessary
          if (variant.compare_at_price > variant.price) {
            this.cache.comparePrice.innerHTML = theme.Currency.formatMoney(variant.compare_at_price, theme.settings.moneyFormat).replace('.00', '');
            ...
            if (theme.settings.saveType == 'percent') {
              ...
              savings = theme.Currency.formatMoney(savings, theme.settings.moneyFormat).replace('.00', '');
            }
      ...
      updateUnitPrice: function(evt) {
        ...
        if (variant && variant.unit_price) {
          this.container.querySelector(this.selectors.unitPrice).innerHTML = theme.Currency.formatMoney(variant.unit_price, theme.settings.moneyFormat).replace('.00', '');
